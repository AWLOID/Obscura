...
local ThemeDark = {
    ...
    Bg3         = Color3.fromRGB(32, 33, 40),
    Hover       = Color3.fromRGB(42, 43, 52),
    Border      = Color3.fromRGB(38, 39, 48),
    BorderHi    = Color3.fromRGB(72, 74, 90),
    Text        = Color3.fromRGB(238, 239, 245),
    SubText     = Color3.fromRGB(150, 152, 165),
    DimText     = Color3.fromRGB(98, 100, 112),
    Accent      = Color3.fromRGB(124, 110, 240),
    AccentText  = Color3.fromRGB(245, 245, 255),
    Track       = Color3.fromRGB(44, 45, 55),
    Shadow      = Color3.fromRGB(0, 0, 0),
    Knob        = Color3.fromRGB(245, 245, 252),
}

local Theme = {}
for k, v in pairs(ThemeDark) do Theme[k] = v end
Library.Theme       = Theme
local ThemeMidnight = {
